import { IonButton, IonContent, IonInput, IonItem, IonLabel, IonList, IonModal, IonText } from '@ionic/react';
...
const Home: React.FC = () => {
  ...
  return (
    <IonContent>
      ...
      <IonButton onClick={() => setShowModal(true)}>Ajouter un match</IonButton>
