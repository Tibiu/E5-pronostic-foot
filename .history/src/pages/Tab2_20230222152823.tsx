        ...
        <IonModal ref={modal} trigger="open-modal" onWillDismiss={(ev) => onWillDismiss(ev)}>
          ...
          <IonContent className="ion-padding">
            ...
            <IonItem>
              ...
              <IonInput name="homeTeam" placeholder="Your name" value={match.homeTeam} onIonChange={handleInputChange} />
            </IonItem>

            <IonItem>
              <IonLabel position="stacked">Equipe à l'extérieur:</IonLabel>
              <IonInput name="awayTeam" placeholder="Your name" value={match.awayTeam} onIonChange={handleInputChange} />
            </IonItem>

            <IonItem>
              <IonLabel position="stacked">Score:</IonLabel>
              <IonInput name="score" placeholder="Your name"value={match.score} onIonChange={handleInputChange} />
            </IonItem>
